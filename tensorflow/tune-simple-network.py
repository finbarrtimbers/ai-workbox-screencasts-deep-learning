...
# Our first layer
W1 = tf.get_variable("weights-1", shape=[784, 392],
                    initializer=tf.glorot_uniform_initializer())
b1 = tf.get_variable("bias-1", [392],
                    initializer=tf.constant_initializer(0.1))
y1 = tf.nn.relu(tf.matmul(x, W1) + b1)

W2 = tf.get_variable("weights-2", shape=[392, 10],
                    initializer=tf.glorot_uniform_initializer())
b2 = tf.get_variable("bias-2", [10],
                    initializer=tf.constant_initializer(0.1))
...
experiment_name = "two-hidden-layers-fully-connected-network-adam" + time_string
